...
This modpack is a curated collection of independently-authored mods. All mods remain the
property of their original authors. If you are an author of an included mod and want it
removed or credited differently, open an issue or PR and it will be handled promptly.

Sources verified live 2026-08-31. Unless noted, gta5-mods.com standard terms apply —
please ask authors before redistributing their work elsewhere.

## Script mods

| Mod | Author | URL | Notes |
|---|---|---|---|
| The Vinewood Club Live (Vinewood Car Club, Enhanced) | andre500 | https://www.gta5-mods.com/scripts/the-vinewood-club-live | Syncs Vinewood Garage premium car list from GTA Online (reads globals only, no MP writes). Needs licensed/online-connected copy for live car updates. |
| Odd Jobs (Odd Jobs SP) | andre500 | https://www.gta5-mods.com/scripts/odd-jobs-sp | SP port of GTA Online odd jobs (pizza delivery, firefighter, forklift, helicopter tour, paper route, weed delivery, etc.). |
| VI Wanted System | andre500 | https://www.gta5-mods.com/scripts/vi-wanted-system | Recreates GTA VI wanted system. |
| AddonWeapons | andre500 | https://www.gta5-mods.com/scripts/addonweapons | Turns replace-weapons into add-ons, buyable at Ammu-Nation. Ships no weapons itself. |
| Sleep Anywhere | andre500 | https://www.gta5-mods.com/scripts/sleep-anywhere | Sleep anywhere + optional fatigue system. |
| HSW in SP (Hao's Special Works) | andre500 | https://www.gta5-mods.com/scripts/hao-s-special-works-in-sp | Hao's Special Works tuning + LS Car Meet in SP. |
| Fan Crowd | andre500 | https://www.gta5-mods.com/scripts/fan-crowd | Autograph minigame as Michael/Franklin/Trevor/Dr. Dre. |
| iFruit Jailbreak | andre500 | https://www.gta5-mods.com/tools/ifruit-jailbreak-sending-sms-and-emails | Library injecting contacts/phone numbers/SMS/emails into the in-game phone via globals. |
| Madrazo Hits | andre500 | https://www.gta5-mods.com/scripts/madrazo-hits | "Madrazo Hits" missions from GTA Online in SP. Requires iFruit Jailbreak 4.0+. |
| Online Vehicles Shops in SP | andre500 | https://www.gta5-mods.com/scripts/online-vehicles-shops-in-sp | Patches vehicle-sale websites so GTA Online cars are buyable in SP. Needs scaleform web.rpf .gfx replacement; delivers to Vinewood Club Garage if installed. |
| Online Workshops in SP | andre500 | https://www.gta5-mods.com/scripts/online-workshops-in-sp | Nine GTA Online workshops (incl. Hao's drift tuning) in story mode. |
| Finger Gestures | andre500 | https://www.gta5-mods.com/scripts/finger-gestures | Point/middle-finger gestures on foot. |
| Improved TaxiDriver | andre500 | https://www.gta5-mods.com/scripts/improved-taxi-driver | Work as taxi driver in any car. |
...
| Mod | Author | URL | Notes |
|---|---|---|---|
| MP Characters Overhaul Gen9 (mpPlayersFixes_Gen9) | Alex106 | https://www.gta5-mods.com/player/improved-mp-freemode-clothes | Fixes MP ped body/clothes/accessory models, textures and overlay/metadata files. |
| Eclipse Complex MLO (eclipse_complex) | meimeiriver, Raymax3d | https://www.gta5-mods.com/maps/eclipse-complex | See script mods entry. |
| Mechanic Garage (mechanic_garage) | Rfc Mapping (original); DimoSerb (Enhanced conversion) | https://www.nexusmods.com/gta5enhanced/mods/848 | "Mod converted and posted with author's permission." |
| Sweet Milk Farm | -NyX' | https://www.gta5-mods.com/maps/sweet-milk-farm-add-on-sp-fivem | Grand Senora Desert, west of Sandy Shores Airport. |
| bmamas | LeetSombrero | https://www.gta5-mods.com/maps/lively-bahama-mamas-wip | dlcpack of Lively Bahama Mamas. |
| bmamas_level | LeetSombrero | https://www.gta5-mods.com/maps/lively-bahama-mamas-wip | Interior level of Lively Bahama Mamas. |
| desert_mansion | Guillaume56 (original); DimoSerb (Enhanced conversion) | https://www.nexusmods.com/gta5enhanced/mods/1215 | Original: libertycity.net "Desert Mansion 2.0". |
...
| vinewood_hills_mansion_02 | Guillaume56 (original); DimoSerb (Enhanced conversion) | https://www.nexusmods.com/gta5enhanced/mods/1275 | "Vinewood Hills Mansion 2 (Add-On)". |

## Framework & tools (not mods, but shipped in the pack)
